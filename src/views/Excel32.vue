              ...
              <tbody>
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td class="blue">46</td>
                        <td>{{a46_1|formatCurrency}}</td>
                        <td>{{a46_2|formatCurrency}}</td>
                    </tr>
                    <tr>
                        ...
                        <td class="blue">47</td>
                        <td>{{a47_1|formatCurrency}}</td>
                        <td>{{a47_2|formatCurrency}}</td>
                    </tr>  
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="blue">52</td>
                        <td>{{a52_1|formatCurrency}}</td>
                        <td>{{a52_2|formatCurrency}}</td>
                    </tr>  
                    <tr>
